  ...
  rounded-2xl ${cfg.iconBg}`} style={{ zIndex: 0 }}/>
   <div className='relative z-10'>
            ...
            whileHover={{ rotate: -6, scale: 1.1 }}
                ...
                className={`w-11 h-11 rounded-xl flex items-center justify-center ${cfg.iconBg} ${cfg.
                iconColor}`}
            >
                {icon}
            </motion.div>
                    <p className='text-xs font-semibold uppercase tracking-widest  text-gray-400 mb-1'>{label}</
p>
