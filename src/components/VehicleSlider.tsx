...
const VEHICLE_CATEGORIES = [
  ...
  { title: "Bike", desc: "Fast & affordable rides", Icon: Bike, tag: "Quick" },
            ...
            {VEHICLE_CATEGORIES.map((c, i) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -8 }}
                  className="group relative min-w-[220px] sm:min-w-[260px] flex-shrink-0
              cursor-pointer"
                >
                  <motion.div
                    animate={{
...
<div key={i} className="flex items-center gap-3">
  ...
  <p className='text-zinc-400 text-xs font-mediumd'>{d.label}</p>
</div>
