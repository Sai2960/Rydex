...
function Page() {
  ...
  const onChatToggle = () => setChatOpen((prev) => !prev);
  ...
  return (
    <div className="h-screen w-full bg-zinc-100 flex flex-col lg:flex-row overflow-hidden">
      ...
      <motion.div
        ...
        className="hidden lg:flex flex-col w-[420px] xl:w-[460px] bg-white border-l border-zinc-100 overflow-hidden"
      >
                ...
                >
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <button
                      ...
                      className="w-full bg-zinc-900 hover:bg-zinc-800 disabled:opacity-40 text-white py-2.5 rounded-xl text-sm font-bold active:scale-[0.97] transition-all"
                    >
                      {loadingOtp ? (
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-20 pointer-events-none">
        ...
        >
          ...
          {/* Divider line */}
          <div className="flex-shrink-0 h-px bg-zinc-100 mx-5" />
