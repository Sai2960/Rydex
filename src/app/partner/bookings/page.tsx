            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">
                  ...
                  assigned to you {/* ✅ Fix 2: no crash */}
                </p>
              </div>
            </div>
          </div>
                    ...
                    >
                      <div
                        className="w-12 h-12 rounded-full overflow-hidden
                         bg-blue-200 flex-shrink-0 border-2  border-white shadow-sm
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span
                            className={`px-2 py-1 rounded-full text-xs
                                font-medium ${getStatusColor(b.bookingStatus)}`}
                          >
                            {b.bookingStatus || "-"}
                          </span>
                        </div>
...
□text-gray-600"
                    ...
                    <div className="p-4 space-y-3">
                      <div className="flex items-start gap-3">
                        <div
                          className="flex-shrink-0 w-6 h-6  bg-green-100
        rounded-full flex items-center justify-center"
            ...
            leading-relaxed"
                    ...
                    <div className="p-4 space-y-3">
                      <div className="flex items-start gap-3">
                        <div
                          className="flex-shrink-0 w-6 h-6  bg-red-100
        rounded-full flex items-center justify-center"
                        >
